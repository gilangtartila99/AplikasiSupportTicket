 ...
 */
class TicketSupportSearch extends Ticket
{
    ...
    {
        $query = Ticket::find()->joinWith(['category'])->andWhere(['state' => ['Open', 'Hold On'], 'support_id' => Yii::$app->user->identity->id])->orderBy(['state' => SORT_DESC, new \yii\db\Expression('FIELD(prioritas, "Tinggi","Sedang","Rendah")')]);
